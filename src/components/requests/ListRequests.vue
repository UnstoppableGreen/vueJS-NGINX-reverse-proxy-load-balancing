      ...
      <div class="py-8 md:py-4">
        ...
        <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-6 overflow-x-auto">
          <div class="flex justify-between">
            <div>
              <p class="text-3xl font-bold">Запросы к поставщикам</p>
              <p class="text-gray-400 mt-2 mb-5">{{ data.total }} запросов</p>
            </div>
            <filter-request @setFilter="filterData"></filter-request>
          </div>
          <div
...
import Request from "../requests/Request.vue";
import paginateList from "../../composables/PaginateUniversal";
import FilterRequest from "../../components/functionalities/FilterRequest.vue";
