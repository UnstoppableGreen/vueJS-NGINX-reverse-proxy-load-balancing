...
export default {
    ...
    setup(){
        ...
        const {itemsdata,data,getAllData,EntireItemsList,getEntireItemsList,deleteItem} = useItems() 
        
        //Pagination 
        
        const {page,pages,entries,totalEntries,setPages,setParam} = paginateList(data)
        ...
        const filterData=(data)=>{
            ...
            switch(data){
                case 'asc':
                    filteredData.value = Array.from(EntireItemsList.value).sort((a,b)=>{
