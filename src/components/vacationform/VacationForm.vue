          ...
          <form @submit.prevent="saveVacation" class="mt-5">
            <div class="form">
              <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                <div class="mb-3 space-y-2 w-full text-xs">
                  ...
                  <input
                    type="text"
                    v-model="vacationdata.worker.id"
			...
			<div  class="md:flex md:flex-row md:space-x-4 w-full text-xs">
				<div class="w-full flex flex-col mb-3">
					...
					<input v-model="vacationdata.endDate"  type="date" placeholder="2021-01-01" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" name="integration[street_address]" id="integration_street_address">
				</div>
			</div>
			...
			<div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
				<div class="w-full flex flex-col mb-3">
					...
					<input v-model="vacationdata.commandDate"  type="date" placeholder="2021-01-01" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" name="integration[street_address]" id="integration_street_address">
				</div>
			</div>
