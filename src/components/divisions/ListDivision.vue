      ...
      <div class="py-8 md:py-4">
        ...
        <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-6 overflow-x-auto">
          <div class="flex justify-between">
            <div>
              <p class="text-3xl font-bold">Подразделения</p>
              <p class="text-gray-400 mt-2 mb-5">{{ data.total }} подразделений</p>
            </div>
            <filter-division @setFilter="filterData"></filter-division>
          </div>
          <div
            class="
              inline-block
...
import Division from "../divisions/Division.vue";
import paginateDivisionList from "../../composables/PaginateUniversal";
import FilterDivision from "../../components/functionalities/FilterDivision.vue";
...
export default {
  ...
  setup() {
    ...
    const filterData = (data) => {
      ...
      switch (data) {
        case "asc":
          filteredData.value = Array.from(EntireDivisionList.value).sort((a, b) => {
